...
UI 全体に **Zen Maru Gothic（丸ゴシック）** を使用しています。やわらかく親しみやすい
丸みのある書体で、続けたくなる雰囲気を狙っています。`res/font` に同梱（オフライン動作）。
ライセンスは SIL Open Font License 1.1（`licenses/ZenMaruGothic-OFL.txt`）。
